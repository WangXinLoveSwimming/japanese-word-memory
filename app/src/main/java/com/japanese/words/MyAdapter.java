...
//ahking, 使用listAdapter, 而不是之前的recyclerview.adapter的原因是, 当插入的时候可以自动处理动画.
...
public class MyAdapter extends ListAdapter<Word,MyAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.textViewPronounce.setText(word.getPronounce());
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        TextView textViewNumber,textViewEnglish,textViewChinese, textViewPronounce;
        ...
        MyViewHolder(@NonNull View itemView) {
            ...
            textViewPronounce = itemView.findViewById(R.id.textViewPronounce);
